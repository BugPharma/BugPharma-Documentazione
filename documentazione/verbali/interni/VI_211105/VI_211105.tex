...
\begin{document}
	...
	\begin{titlepage}
		\begin{center}
			...
			Resoconto incontro con Zucchetti
	...
	\section{Punti salienti}
		\begin{itemize}
			\item C5 sembra fattibile: tutti sono propensi a scegliere questo capitolato;
			\item l'azienda è aperta a idee da parte nostra e disponibile;
			\item Appena è possibile ci risentiamo per definire meglio il WoW e per iniziare a pensare alla candidatura per aggiudicarsi l’appalto.
		\end{itemize}
