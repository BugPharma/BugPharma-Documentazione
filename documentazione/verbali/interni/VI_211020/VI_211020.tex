	...
	\section{Punti salienti}
		\begin{itemize}
			...
			\begin{itemize}
				...
				\item C1 - Bot4Me.
			\end{itemize}
			\item Si decide di concentrarsi inizialmente sui primi due (C5 e C2);
			\item Si decide di suddividersi in due gruppi per analizzare i primi due capitolati scelti ed evidenziare
			...
			\item Sono stati proposti alcuni possibili nomi per il gruppo:
				\begin{itemize}
					...
					\item Bug Pharma.
				\end{itemize}
			\item Si decide di poter proporre, in settimana, altri nomi e loghi e di votare i definitivi in un secondo momento
